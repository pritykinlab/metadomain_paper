...
def plot_megaloop_network_enrichment(all_intra_tcon_megaloops, CHROMS_TO_USE, chrom_to_start, chrom_to_end, chrom_sizes, cutoffs = [0]):
    n = len(cutoffs)
    ...
    for c, cutoff in enumerate(cutoffs):
        ...
        for chrom in CHROMS_TO_USE:
            ...
            submat = all_intra_tcon_megaloops[s:e, s:e]
            inds_with_megaloops = submat.sum(axis=0) > cutoff
            submat = submat[inds_with_megaloops, :][:, inds_with_megaloops]
